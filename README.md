...
If you tired of building an 'New Dashboard' for each app that have an database and pure database dashboards looks overhealming you should take a look at this application.
